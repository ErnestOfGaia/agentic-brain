...
| Tool | Category |
|------|----------|
| Claude Desktop | AI assistant (primary) |
| Abacus AI | AI CoWork platform |
| ChatGPT | AI assistant (secondary) |
| Perplexity | AI research |
| Cursor | AI code editor |
| Kodee | VPS management |
| Firefox / Brave / Chrome | Browsers |
| Comet | Browser (AI-native) |
| Clawx / Ollama | Local LLM tools |

## Distribution Channels

| Channel | Format |
|---------|--------|
| Medium | Long-form quarterly brief |
| LinkedIn | Professional summary post |
| X / Twitter | Short takes and highlights |
| YouTube | Video walkthrough |

## Tech Stack
- **Research:** Apify (future), Perplexity
- **Automation:** n8n (future), Cowork task templates
